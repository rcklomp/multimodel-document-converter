...
9. `docs/QUALITY_SNAPSHOT_2026-05-22_v2.13_after.md` (**current canonical baseline**; v2.13.0 SHIPPED 2026-05-22 — local omlx embedder swap + OCR auto-routing; apples-to-apples 6/6-axis omlx win vs dashscope on same fixture: R@1 +2.5pp, R@5c +5.4pp, R@5d +2.1pp, Relevance +0.5pp, Format +3.7pp, Faithfulness +1.0pp)
10. `docs/QUALITY_SNAPSHOT_2026-05-22_v2.13_p1_omlx_vs_dashscope.md` (v2.13 Phase 1 SWAP evidence — canonical comparison report)
11. `docs/QUALITY_SNAPSHOT_2026-05-21_v2.12_after.md` (v2.12.0 predecessor baseline — retrieval stack hybrid+rerank, R@1 67.8% on v2.11 fixture)
12. `docs/QUALITY_SNAPSHOT_2026-05-20_v2.11_soak_qwen3.md` (v2.11.0 baseline soak — Recall@1 35.5%; the 518-query fixture every v2.12 soak ran against)
13. `docs/QUALITY_SNAPSHOT_2026-05-16_v2.10_after.md` (v2.10 strict-gate baseline — 34/34 PASS; unchanged in v2.11 + v2.12 + v2.13 because all three cycles touched retrieval-side / OCR-routing only)
14. `docs/PLAN_V2.13.md` (v2.13 execution history — CLOSED 2026-05-22, tag `v2.13.0` staged for user push)
15. `docs/PLAN_V2.12.md` (v2.12 execution history — CLOSED 2026-05-21, tag `v2.12.0` on `5a2ce18` public on GitHub + Gitea)
16. `docs/PLAN_V2.11.md` (v2.11 execution history — CLOSED 2026-05-20, tag `v2.11.0` on `c2a461c`)
17. `docs/PLAN_V2.10.md` (v2.10 execution history — CLOSED 2026-05-16, tag `v2.10.0` on `db6527c`)
