...
**Engine version:** `v2.12.0` in `src/mmrag_v2/version.py` and `pyproject.toml`. Annotated tag `v2.12.0` is PUBLIC on both `github` and `origin` (Gitea, 10.0.10.241). Next tag pending: `v2.13.0` (in-progress autonomous run; staged for user push at Phase N close). Predecessors: `v2.12.0` (2026-05-21, `5a2ce18`), `v2.11.0` (2026-05-20, `c2a461c`), `v2.10.0` (2026-05-16, `db6527c`). Schema version `2.7.0` — chunk-shape contract unchanged since v2.7.
