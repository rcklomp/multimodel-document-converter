...
if text_count > 0 or picture_count > 0:
    print("✅ VERDICT: Docling DOES detect elements on scanned Firearms.pdf!")
    print("   → Opus design will work as specified")
else:
    print("❌ VERDICT: Docling returns 0 elements - need fallback strategy")
