...
**Date:** May 2026
**Status:** PRODUCTION — v2.12.0 is current (commit pending push; annotated tag staged for user push). Predecessors: `v2.11.0` (2026-05-20, `c2a461c`), `v2.10.0` (2026-05-16, `db6527c`), `v2.9.0-rc1` (2026-05-12, `3e06d1b`), `v2.8.0` (2026-05-04, `645ab2b`).
