...
- [ ] Skim active plan docs: `docs/PLAN_V2.9_DRAFT_PROMPT.md` (next-cycle plan-writing prompt — v2.9 plan itself not yet drafted as of 2026-05-04). For shipped reference: `docs/archive/PLAN_V2.8_PRODUCTION_GAPS.md` (SHIPPED 2026-05-04, tag `v2.8.0` on `645ab2b`) and `docs/archive/PLAN_DOCLING_POSTPROCESSOR.md` (folded into v2.8). For overall arc context, `docs/archive/PLAN_V2.7_DOCUMENT_UNDERSTANDING.md` (archived 2026-05-03) remains as rationale.
...
- [x] Create dated quality snapshot.
  - Evidence: `docs/archive/quality_snapshots/QUALITY_SNAPSHOT_2026-04-29.md`
...
Current status: `[x]` — `complete` (2026-05-01). Full evidence in `docs/archive/quality_snapshots/QUALITY_SNAPSHOT_2026-05-01.md`.
