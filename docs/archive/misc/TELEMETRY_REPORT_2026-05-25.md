...
- IMPORTANCE OVERRIDE (HIGH forces Option A regardless of telemetry): FIRED
...
- v2.X disposition: Option A treatment (HIGH personal_importance override; telemetry quiet)
